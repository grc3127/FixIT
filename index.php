...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.php" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">FixIT</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          ...
          <!--START OF CARDS FOR JOB REQUEST STATISTICS-->
          <div class="row">
            <!--begin::Col-->
          ...
          <!--END OF CARDS FOR JOB REQUEST STATISTICS-->
          
          <!-- START OF ITEM REQUEST STATISTICS  -->
          <div class="row">
            <div class="container-fluid">
            <div class="card-body">
              <div class="card mb-4">
          ...
          <!-- END OF ITEM REQUEST STATISTICS  -->
          
          <!--START OF CARDS FOR ITEM REQUEST STATISTICS-->
          <div class="row">
            <!--begin::Col-->
            <div class="col-lg-3 col-6">
              <!--begin::Small Box Widget 1-->
          ...
          <!--END OF CARDS FOR ITEM REQUEST STATISTICS-->
    ...
    <script>
      ...
      const sales_chart1 = new ApexCharts(
        document.querySelector('#sales-chart1'),
        sales_chart_options,
      );
      const sales_chart2 = new ApexCharts(
        document.querySelector('#sales-chart2'),
        sales_chart_options,
      );
      sales_chart1.render();
      sales_chart2.render();
